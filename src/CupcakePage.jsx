...
import img from './assets/cupcake2.jpeg'; 
    ...
    <div className="menu-page-wrapper">
      <div className="menu-container">
        <h1 className="main-title">
          Menu <span className="separator">|</span> <span className="category-name">Cupcake</span>
        </h1>
        ...
        <div className="product-detail-section">
          ...
          <div className="detail-left">
            <div className="image-white-box">
              <img src={img} alt="Cupcake" />
            </div>
          </div>

          {/* Sisi Kanan: Informasi */}
          <div className="detail-right">
            <h2 className="detail-name">Cupcake</h2>
            <div className="detail-desc">
              <p>Kue mini lembut dengan topping cantik dan rasa lezat, cocok untuk segala suasana.</p>
              <p><strong>Estimasi PO:</strong> 1-2 hari</p>
              <p><strong>Maks. pemesanan:</strong> 4 pcs</p>
            </div>
            
            <h3 className="detail-price">Rp 35.000</h3>
