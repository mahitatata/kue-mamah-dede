    ...
    <div className="pesanan-page-wrapper">
      <div className="pesanan-content">
        ...
        <div className="filter-group">
          ...
          <Link to="/pesanan/dibatalkan" className="filter-btn active">Dibatalkan</Link>
          ...
          <div className="order-card">
            <div className="order-info">
              ...
              <div className="order-details">
                ...
                <p>Rp 41.000</p>
                <span className="status-badge" style={{ backgroundColor: '#A12628' }}>Dibatalkan</span>
              </div>
            </div>
