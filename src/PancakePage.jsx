...
import img from './assets/pancake.jpeg'; 

function PancakePage() {
    ...
    <div className="menu-page-wrapper">
      <div className="menu-container">
        <h1 className="main-title">
          Menu <span className="separator">|</span> <span className="category-name">Strawberry Pancake</span>
        </h1>
        ...
        <div className="product-detail-section">
          ...
          <div className="detail-left">
            <div className="image-white-box">
              <img src={img} alt="Pancake" />
            </div>
          </div>

          {/* Sisi Kanan: Informasi */}
          <div className="detail-right">
            <h2 className="detail-name">Strawberry Pancake</h2>
            <div className="detail-desc">
              <p>Pancake lembut dengan topping stroberi segar dan rasa manis yang menyegarkan.</p>
              <p><strong>Estimasi PO:</strong> 1-2 hari</p>
              <p><strong>Maks. pemesanan:</strong> 10 pcs</p>
            </div>
            
            <h3 className="detail-price">Rp 25.000</h3>
